...
cse303.leftmsg("Copying AES files into place")
cse303.copyexefile("obj64/server.p1.aes.exe", "obj64/server.exe")
cse303.copyexefile("obj64/client.p1.aes.exe", "obj64/client.exe")
cse303.okmsg()

# The AES test runs a battery of GET and SET, to stress crypto.o
print()
cse303.line()
print("Test: AES: Stressing AES (be sure to run script with SERVER, CLIENT, and no overrides)")
cse303.line()
